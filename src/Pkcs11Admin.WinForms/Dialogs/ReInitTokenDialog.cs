...
{
    public partial class ReInitTokenDialog : Form
    {
        ...
        {
            TextBoxCurrentPin.UseSystemPasswordChar = !CheckBoxDisplayPin.Checked;
        }
        ...
        private void ReInitTokenDialog_InputLanguageChanged(object sender, InputLanguageChangedEventArgs e)
        {
            UpdateStatusStrip();
        }

        private void ReInitTokenDialog_KeyDown(object sender, KeyEventArgs e)
        {
            UpdateStatusStrip();
        }
